...
class PlayState extends MusicBeatState
{
	...
	public var bgGrp:FlxTypedGroup<BGSprite>;
	public var frontBgGrp:FlxTypedGroup<BGSprite>;
	...
	override public function create()
	{
		...
		if(PlayState.SONG.stage == null || PlayState.SONG.stage.length < 1) {
			switch (songName)
			{
				case 'confidential' | 'trickster' | 'top-secret':
					curStage = 'normalBg';
				default:
					curStage = 'stage';
			}
		...
		bgGrp = new FlxTypedGroup<BGSprite>();
		add(bgGrp);
		...
		switch (curStage)
		{
			...
			case 'spyBg':
				...
				var sky:BGSprite = new BGSprite('bg/normalBg/Sky', -384, -240, 0.9, 0.9);
				sky.setGraphicSize(Std.int(sky.width * 1.8));
				bgGrp.add(sky);
				
				var arboles:BGSprite = new BGSprite('bg/normalBg/Arboles Lejanos', -384, -240, 0.9, 0.9);
				arboles.setGraphicSize(Std.int(arboles.width * 1.8));
				bgGrp.add(arboles);
				
				var troncos:BGSprite = new BGSprite('bg/normalBg/troncos', -384, -240, 0.9, 0.9);
				troncos.setGraphicSize(Std.int(troncos.width * 1.8));
				bgGrp.add(troncos);
				
				var bg8:BGSprite = new BGSprite('bg/normalBg/arbol 8', -384, -240, 0.9, 0.9);
				bg8.setGraphicSize(Std.int(bg8.width * 1.8));
				bgGrp.add(bg8);
				
				var bg7:BGSprite = new BGSprite('bg/normalBg/arbol 7', -384, -240, 0.9, 0.9);
				bg7.setGraphicSize(Std.int(bg7.width * 1.8));
				bgGrp.add(bg7);
				
				var bg6:BGSprite = new BGSprite('bg/normalBg/arbol 6', -384, -240, 0.9, 0.9);
				bg6.setGraphicSize(Std.int(bg6.width * 1.8));
				bgGrp.add(bg6);
				
				var bg5:BGSprite = new BGSprite('bg/normalBg/arbol 5', -384, -240, 0.9, 0.9);
				bg5.setGraphicSize(Std.int(bg5.width * 1.8));
				bgGrp.add(bg5);
				
				var bg4:BGSprite = new BGSprite('bg/normalBg/arbol 4', -384, -240, 0.9, 0.9);
				bg4.setGraphicSize(Std.int(bg4.width * 1.8));
				bgGrp.add(bg4);
				
				var bg3:BGSprite = new BGSprite('bg/normalBg/arbol 3', -384, -240, 0.9, 0.9);
				bg3.setGraphicSize(Std.int(bg3.width * 1.8));
				bgGrp.add(bg3);
				
				var bg2:BGSprite = new BGSprite('bg/normalBg/arbol 2', -384, -240, 0.9, 0.9);
				bg2.setGraphicSize(Std.int(bg2.width * 1.8));
				bgGrp.add(bg2);
				
				var bg1:BGSprite = new BGSprite('bg/normalBg/arbol 1', -384, -240, 0.9, 0.9);
				bg1.setGraphicSize(Std.int(bg1.width * 1.8));
				bgGrp.add(bg1);
				
				var pasto:BGSprite = new BGSprite('bg/normalBg/Pasto', -384, -240);
				pasto.setGraphicSize(Std.int(pasto.width * 1.8));
				bgGrp.add(pasto);
				
				var piedras1:BGSprite = new BGSprite('bg/normalBg/Piedras 1', -384, -240);
				piedras1.setGraphicSize(Std.int(piedras1.width * 1.8));
				bgGrp.add(piedras1);
				
				var piedras2:BGSprite = new BGSprite('bg/normalBg/Piedras 2', -384, -240);
				piedras2.setGraphicSize(Std.int(piedras2.width * 1.8));
				bgGrp.add(piedras2);
		}
		...
		if (curStage == 'spyBg')
		{
			frontBgGrp = new FlxTypedGroup<BGSprite>();
			add(frontBgGrp);

			var vallas:BGSprite = new BGSprite('bg/normalBg/Vallas', -384, -240, 1.1, 1.1);
			vallas.setGraphicSize(Std.int(vallas.width * 1.8));
			frontBgGrp.add(vallas);
		}
	...
	public function normalBg()
	{
		if (curStage == 'spyBg')
		{
			bgGrp.forEachAlive(function(spr:BGSprite)
			{
				spr.destroy();
				bgGrp.clear();
			});
			
			frontBgGrp.forEachAlive(function(spr:BGSprite)
			{
				spr.destroy();
				frontBgGrp.clear();
			});
	...
	public function lineArtBg()
	{
		if (curStage == 'spyBg')
		{
			...
			var bgF:BGSprite = new BGSprite('bg/lineArtBg/bg', -384, -100);
			bgF.setGraphicSize(Std.int(bgF.width * 1.6));
			bgGrp.add(bgF);
			
			var bgF1:BGSprite = new BGSprite('bg/lineArtBg/front', -384, -100);
			bgF1.setGraphicSize(Std.int(bgF1.width * 1.6));
			bgGrp.add(bgF1);
			
			var frontF:BGSprite = new BGSprite('bg/lineArtBg/front', -384, -100);
			frontF.setGraphicSize(Std.int(frontF.width * 1.6));
			frontF.alpha = 0.5;
			frontBgGrp.add(frontF);
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Zoom Trans':
				defaultZoomEvent = FlxG.camera.zoom;
				
				FlxTween.tween(FlxG.camera, {zoom: FlxG.camera.zoom + 0.5}, 0.5, {ease: FlxEase.backIn, 
					onComplete: function(twn:FlxTween)
					{
						FlxG.camera.zoom = defaultZoomEvent;
					}
				});
